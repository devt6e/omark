...
public class MarkerInfoPanel : MonoBehaviour
{
    ...
    [SerializeField] private Button btnRealDelete;
    [SerializeField] private Button btnRealDeleteCancel;
    ...
    [SerializeField] private GameObject deleteCheckPanel;
    ...
    private void Awake()
    {
        ...
        btnDelete.onClick.AddListener(DeleteCheckPanelShow);
        btnRealDelete.onClick.AddListener(RealDelete);
        btnRealDeleteCancel.onClick.AddListener(DeleteCheckPanelHide);
    ...
    private void DeleteCheckPanelShow()
    {
        deleteCheckPanel.gameObject.SetActive(true);
    }

    private void RealDelete()
    {
        MarkerSlotSpawner.Current?.RemoveSlot(currentDefinitionId);
        Close();
    }

    private void DeleteCheckPanelHide()
    {
        deleteCheckPanel.gameObject.SetActive(false);
    }
